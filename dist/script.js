...
class App extends React.Component {
  ...
  render() {
    ...
    return (
      ...
      React.createElement("div", { className: "author" }, "Developed by ", React.createElement("br", null), " ", React.createElement("a", { href: "https://codepen.io/soumyadeepta_das/", target: "_blank" }, "Soumyadeepta Das"))));
...
const Toolbar = props => {
  return (
    ...
    React.createElement("i", { title: "soumyadeepta_das", className: "fa fa-file-text" }),
    props.text,
